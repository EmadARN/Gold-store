export const steps = [
  {
    ...
    description: `ثبت نام در طلای آدلی کارا ساده بوده و در چند دقیقه اتفاق میافتد.نیازی نیست به جایی مراجعه کنید یا عکس یا فیلمی بارگزاری گنید.`,
  },
  {
    id: 2,
    label: "شارژ کیف پول",
    description: `
      با ثبت‌نام در طلای آدلی کارا برای شما یک کیف‌پول ریالی و یک کیف طلا ایجاد می‌شود. برای
